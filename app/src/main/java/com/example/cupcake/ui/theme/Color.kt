...
val md_theme_light_primary = Color(0xFFFF99B0)
val md_theme_light_onPrimary = Color(0xFFDCD5D7)
val md_theme_light_primaryContainer = Color(0xFFA26FDA)
val md_theme_light_onPrimaryContainer = Color(0xFFEEEAEB)
val md_theme_light_secondary = Color(0xFF74565F)
val md_theme_light_onSecondary = Color(0xFFE80F0F)
